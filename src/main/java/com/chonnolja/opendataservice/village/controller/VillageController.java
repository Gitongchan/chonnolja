...
public class VillageController {
    ...
    //사업자 탈퇴
    @PutMapping("/deleted")
    public ResResultDto villageDeleted(@LoginUser UserInfo userInfo, @RequestBody VillageUserInfoDto villageUserInfoDto){

        Long result = villageService.villageDeleted(userInfo, villageUserInfoDto);
        return result == -1L ?
